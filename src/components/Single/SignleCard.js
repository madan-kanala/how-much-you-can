...
const SingleCard = ({ followers, engagementRate, from, to, start = 9 }) => {
  return (
    <>
      <div className='hidden lg:block auto text-center box-border rounded-3xl mb-4 mt-20 py-7'>
        <motion.p
        ...
        <div className='w-full sm:w-[24rem] md:w-[26rem] lg:w-[35rem] sm:mx-auto text-center box-border rounded-3xl mb-4'>
          <motion.p
            {...defaultAnimationsResult}
          ...
          >
            <div>
              <motion.p
                ...
                transition={{
                  duration: 1,
                  delay: durationForResult()[start + 5],
                }}
              ...
              <motion.p
                ...
                transition={{
                  duration: 1,
                  delay: durationForResult()[start + 6],
                }}
            ...
            <div>
              <motion.p
                ...
                transition={{
                  duration: 1,
                  delay: durationForResult()[start + 7],
                }}
                className='text-4xl lg:text-5xl font-semibold text-white'
              >
                {engagementRate}%
              ...
              <motion.p
                ...
                transition={{
                  duration: 1,
                  delay: durationForResult()[start + 8],
                }}
                className='text-white text-xs lg:text-xl'
              >
                Engagement Rate
      ...
      <div className=' lg:hidden w-full sm:w-[24rem] md:w-[26rem] lg:w-[35rem] py-8  sm:mx-auto text-center box-border rounded-3xl mb-4 mt-10'>
        <motion.p
          {...defaultAnimationsResult}
          transition={{ duration: 1, delay: durationForResult()[start + 2] }}
          className='text-5xl md:text-7xl lg:text-8xl text-center text-white font-bold'
